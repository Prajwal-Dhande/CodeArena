        ...
        <div className="glass-card">
          {forgotStep ? (
            ...
            <>
              ...
              {/* OAuth Buttons */}
              {oauthLoading ? (
                <div className="oauth-loading-state" style={{ padding: '30px 0', textAlign: 'center' }}>
                  <Loader2 size={36} color="#ff6b35" className="spin-fast" style={{ margin: '0 auto 16px' }} />
                  <h3 style={{ color: '#fff', fontSize: '18px', marginBottom: '8px' }}>Authenticating...</h3>
                  <p style={{ color: '#888', fontSize: '13px' }}>Please wait while we securely connect your account.</p>
                </div>
              ) : (
                <div className="oauth-buttons" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  <div className="google-btn-wrapper" style={{ width: '100%', height: '44px', overflow: 'hidden', borderRadius: '8px' }}>
                    <GoogleLogin
