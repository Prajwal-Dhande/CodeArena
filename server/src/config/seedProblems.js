...
const PROBLEMS = [
  ...
  // 🔥 PREMIUM INTERVIEW DSA 🔥
  {
    ...
    examples: [
      { input: 'height = [0,1,0,2,1,0,1,3,2,1,2,1]', output: '6', explain: 'Trap 6 units of water between the bars.' }
    ],
    constraints: ['n == height.length'],
    testCases: [{ input: { height: [0,1,0,2,1,0,1,3,2,1,2,1] }, expected: 6, functionCall: 'trap([0,1,0,2,1,0,1,3,2,1,2,1])' }],
    starterCode: { javascript: `function trap(height) {\n\n};` },
    hints: ['Two pointers approach'],
  },
  {
    slug: 'lru-cache',
    title: 'LRU Cache',
    ...
    hints: ['Use a doubly linked list + hash map'],
  },
  {
    ...
    examples: [{ input: 'nums = [1,1,1], k = 2', output: '2', explain: 'The subarrays are [1, 1] at indices 0,1 and 1,2.' }],
    constraints: ['1 <= nums.length <= 2 * 10^4', '-1000 <= nums[i] <= 1000'],
    testCases: [{ input: { nums: [1,1,1], k: 2 }, expected: 2, functionCall: 'subarraySum([1,1,1], 2)' }],
  ...
  },
  {
    ...
    isPremium: true,
    description: 'Given a string s, find the length of the longest substring without repeating characters.',
    examples: [{ input: 's = "abcabcbb"', output: '3', explain: 'The answer is "abc", with the length of 3.' }],
    constraints: ['0 <= s.length <= 5 * 10^4'],
    testCases: [{ input: { s: "abcabcbb" }, expected: 3, functionCall: 'lengthOfLongestSubstring("abcabcbb")' }],
  ...
  },
  {
    ...
    difficulty: 'Easy',
    category: 'Strings',
    companies: ['Facebook', 'Spotify', 'Amazon'],
    acceptance: 45,
    isPremium: true,
    ...
    examples: [{ input: 's = "A man, a plan, a canal: Panama"', output: 'true', explain: '"amanaplanacanalpanama" is a palindrome.' }],
    constraints: ['1 <= s.length <= 2 * 10^5'],
    testCases: [{ input: { s: "A man, a plan, a canal: Panama" }, expected: true, functionCall: 'isPalindrome("A man, a plan, a canal: Panama")' }],
    starterCode: { javascript: `function isPalindrome(s) {\n\n};` },
    hints: ['Two pointers starting from ends.'],
  },
  {
    ...
    examples: [{ input: 'root = [2,1,3]', output: 'true', explain: 'Is a valid BST.' }],
    constraints: ['The number of nodes in the tree is in the range [1, 10^4]'],
    testCases: [],
    starterCode: { javascript: `function isValidBST(root) {\n\n};` },
    hints: ['Recursion checking boundaries for min and max bounds.'],
  },
  {
    ...
    examples: [{ input: 'root = [3,1,4,null,2], k = 1', output: '1', explain: '' }],
    constraints: ['The number of nodes in the tree is n.', '1 <= k <= n <= 10^4'],
    testCases: [],
    starterCode: { javascript: `function kthSmallest(root, k) {\n\n};` },
    hints: ['In-order traversal visits nodes in ascending order.'],
  },
  {
    ...
    difficulty: 'Medium',
    category: 'Linked List',
    companies: ['Microsoft', 'Amazon', 'Tencent'],
    acceptance: 46,
    isPremium: true,
    description: 'Given the head of a singly linked list and two integers left and right where left <= right, reverse the nodes of the list from position left to position right, and return the reversed list.',
    examples: [{ input: 'head = [1,2,3,4,5], left = 2, right = 4', output: '[1,4,3,2,5]', explain: '' }],
    constraints: ['The number of nodes in the list is n.'],
    testCases: [],
    starterCode: { javascript: `function reverseBetween(head, left, right) {\n\n};` },
    hints: ['Use dummy node and track the previous node.'],
  },
  {
    ...
    examples: [{ input: 'lists = [[1,4,5],[1,3,4],[2,6]]', output: '[1,1,2,3,4,4,5,6]', explain: 'Merging them gives the sorted linked list.' }],
    constraints: ['k == lists.length', '0 <= k <= 10^4'],
    testCases: [],
    starterCode: { javascript: `function mergeKLists(lists) {\n\n};` },
    hints: ['Divide and Conquer or Priority Queue.'],
  },
]
